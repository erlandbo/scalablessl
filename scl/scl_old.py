...
import numpy as np
from ImageAugmentations import SimCLRTrainTransform
...
if __name__ == "__main__":
    ...
    traindataset = SCLDataset(traindataset,
                              transform=SimCLRTrainTransform(imgsize=IMG_SIZE, s=COLOR_JITTER_STRENGTH, gaus_blur=GAUSSIAN_BLUR, num_views=1, dataset=DATASET),
                              )
